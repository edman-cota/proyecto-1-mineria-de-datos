...
```{r}
cor_men_revenue <- cor(movies$castMenAmount, movies$revenue, use = "complete.obs")
cor_women_revenue <- cor(movies$castWomenAmount, movies$revenue, use = "complete.obs")
cor_men_popularity <- cor(movies$castMenAmount, movies$popularity, use = "complete.obs")
cor_women_popularity <- cor(movies$castWomenAmount, movies$popularity, use = "complete.obs")
